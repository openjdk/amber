...
public final class TransLiterals extends TreeTranslator {
    ...
    class TransStringTemplate {
        ...
        void createValuesListAndMethod() {
            ...
            valuesVar = makeField(templatedStringClass, SYNTHETIC | PRIVATE, names.valuesUpper,
                    listType, null);
            MethodInfo method = createMethod(SYNTHETIC | PUBLIC, names.values,
                    listType, List.nil(), templatedStringClass);
        ...
        void createInitMethod() {
            ...
            MethodInfo method = createMethod(flags, names.init,
                    syms.voidType, types, templatedStringClass);
        ...
        JCExpression createBSMPolicyApplyMethodCall() {
            List<JCExpression> args = expressions.prepend(policy);
            ...
            JCFieldAccess qualifier = make.Select(make.Type(syms.templatePolicyType), dynSym.name);
        ...
        JCExpression createPolicyApplyMethodCall(JCExpression templatedString) {
            MethodSymbol appyMeth = lookupMethod(tree.pos(), names.apply,
                    syms.templatePolicyType, List.of(syms.templatedStringType));
            JCExpression applySelect = make.Select(policy, appyMeth);
        ...
        JCExpression visit() {
            ...
            if (policy == null) {
                ...
                result = createPolicyApplyMethodCall(newTemplatedString());
            }
