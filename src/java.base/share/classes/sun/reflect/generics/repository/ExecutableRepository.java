...
/**
 * This class represents the generic type information for a constructor or a method.
...
public class ExecutableRepository
    ...
    protected ExecutableRepository(String rawSig, GenericsFactory f) {
      super(rawSig, f);
    }
     ...
     */
    public static ExecutableRepository make(String rawSig, GenericsFactory f) {
        return new ExecutableRepository(rawSig, f);
    }
