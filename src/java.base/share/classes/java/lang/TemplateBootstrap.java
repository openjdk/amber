...
final class TemplateBootstrap {
    ...
    private static Object firstInvoke(TemplateBootstrap bootstrap,
        ...
        if (policy instanceof Linkage<Object, Throwable> linkagePolicy && isSafePolicy(policy)) {
    ...
    /**
     * Determine if policy is deemed safe.
     *
     * @param policy  {@link TemplatePolicy} to be checked
     *
     * @return true if the policy is deemed safe
     */
    private static boolean isSafePolicy(TemplatePolicy<Object, Throwable> policy) {
        return "java.base".equals(policy.getClass().getModule().getName());
    }
